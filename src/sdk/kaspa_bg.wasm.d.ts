...
export const header_pom_final_state: (a: number) => bigint;
export const header_pom_tier: (a: number) => number;
export const header_service_state_hash: (a: number, b: number) => void;
...
export const header_set_pom_final_state: (a: number, b: bigint) => void;
export const header_set_pom_tier: (a: number, b: number) => void;
export const header_set_pruning_point_from_js_value: (a: number, b: number) => void;
export const header_set_service_state_hash_from_js_value: (a: number, b: number) => void;
...
export const minerKeyForAddress: (a: number, b: number) => void;
...
export const __wbg_get_transactionutxoentry_effectiveDaaScore: (a: number) => bigint;
...
export const __wbg_set_transactionutxoentry_effectiveDaaScore: (a: number, b: bigint) => void;
...
export const rpcclient_getHolderReward: (a: number, b: number) => number;
...
export const rpcclient_getServiceStrikes: (a: number, b: number) => number;
...
export const __wbindgen_export_12: (a: number, b: number, c: number, d: number) => number;
export const __wbindgen_export_13: (a: number, b: number, c: number) => void;
export const __wbindgen_export_14: (a: number, b: number, c: number, d: number) => void;
