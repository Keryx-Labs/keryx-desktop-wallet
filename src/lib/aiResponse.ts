...
//
// The response references the request by `request_hash` = the AiRequest transaction id
// (32 bytes). AiResponsePayload layout (keryx-node/inference/src/ai_payload.rs):
...
// V1 = 78 bytes; V2 (service-bond era) = 174 bytes, appending the responder's
// escrow pubkey (32) and Schnorr signature (64) over the 78 v1 bytes. Same prefix.
